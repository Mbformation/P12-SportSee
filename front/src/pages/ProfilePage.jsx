  ...
  const userPerformance = formatPerformance(graphData[2]);
    return (
      <div className='profile'>
        <h1 className="title">Bonjour <span className='title-name'>{userData.userInfos.firstName}</span></h1>
        ...
        <div className='stats-container'>
          ...
          <div className='food-kpis-container'>
            <KeyData icon={energy} name="Calories" KeyData={`${userData.keyData.calorieCount}kCal`}/>
            <KeyData icon={protein} name="Protéines" KeyData={`${userData.keyData.proteinCount}g`}/>
            <KeyData icon={carbs} name="Glucides" KeyData={`${userData.keyData.carbohydrateCount}g`}/>
            <KeyData icon={fat} name="Lipides" KeyData={`${userData.keyData.lipidCount}g`}/>
          </div>
        </div>
      </div>
    );
